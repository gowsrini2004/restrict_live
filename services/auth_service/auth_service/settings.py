...
# Database - SQLite default for rapid testing, PostgreSQL in production via env
DB_ENGINE = os.environ.get('DB_ENGINE', 'django.db.backends.sqlite3')
DB_NAME = os.environ.get('DB_NAME', BASE_DIR / 'auth_db.sqlite3')
...
if REDIS_URL:
    ...
    CACHES = {
        'default': {
            ...
            'LOCATION': 'auth-live-session-cache',
        }
    }
