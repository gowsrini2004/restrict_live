...
urlpatterns = [
    ...
    path('admin/stream/toggle-playback/', views.toggle_playback_mode, name='toggle_playback_mode'),
    path('admin/stream/toggle-fallback/', views.toggle_emergency_fallback, name='toggle_emergency_fallback'),
